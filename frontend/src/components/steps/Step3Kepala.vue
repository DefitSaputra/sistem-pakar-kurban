...
const CODES = ['G04', 'G05', 'G06', 'G07', 'G08', 'G15', 'G21', 'G22', 'G23']
...
<template>
  <div class="animate-step">
    <div class="mb-9">
      <span class="text-[10px] font-black uppercase tracking-widest text-emerald-600">Langkah 3 dari 4</span>
      <h2 class="text-3xl font-black text-slate-800 tracking-tight mt-1 mb-2">Area Kepala & Pernapasan</h2>
      <p class="text-slate-500 text-sm max-w-xl leading-relaxed">Periksa kondisi mata, hidung, mulut, air liur berlebih, dan laju pernapasan sapi secara cermat.</p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      >
        ...
        <div>
          ...
          <span class="text-[9px] uppercase font-bold tracking-widest text-slate-400 mt-1.5 block">Kepala & Pernapasan</span>
        </div>
      </label>
    </div>
  </div>
