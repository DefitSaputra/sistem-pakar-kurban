...
const CODES = ['G01', 'G02', 'G03', 'G18', 'G19', 'G20', 'G24', 'G28']
...
<template>
  <div class="animate-step">
    <div class="mb-9">
      <span class="text-[10px] font-black uppercase tracking-widest text-emerald-600">Langkah 2 dari 4</span>
      <h2 class="text-3xl font-black text-slate-800 tracking-tight mt-1 mb-2">Kondisi & Perilaku Umum</h2>
      <p class="text-slate-500 text-sm max-w-xl leading-relaxed">Observasi aktivitas, nafsu makan, postur tubuh, dan respons sapi secara keseluruhan di lapangan.</p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      >
        ...
        <div>
          ...
          <span class="text-[9px] uppercase font-bold tracking-widest text-slate-400 mt-1.5 block">Kondisi & Perilaku</span>
        </div>
      </label>
    </div>
  </div>
